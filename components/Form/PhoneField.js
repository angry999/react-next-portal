...
const PhoneField = React.forwardRef(
    ...
    return (
      <Field
        icon={!noIcon && "fal fa-phone-alt flex-grow-0 text-2xl pt-2 pl-1"}
        error={error}
      ...
      >
        <Select
          ...
          dropIcon={false}
          style={{ fontSize: '24px', appearance: 'none' }}
        ...
        <div className="border-l border-j-lighter -my-2" />
        <Input
          ref={phoneInput}
          {...rest}
          type="number"
        ...
        />
        {checkIcon &&
          <i className="text-j-green-check text-3xl fas fa-check flex-grow-0  pt-2"></i>
        }
