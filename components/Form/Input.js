...
const Input = React.forwardRef(
  ({ className, withIcon, tiny, grow, noClear, type, ...rest }, ref) => {
    ...
    return (
      ...
      >
        <input
          style={{ fontSize: '24px' }}
          className={cx(
            "flex-grow max-w-full placeholder-j-gray-lighter text-gray-700 text-xl  self-center pt-1 pl-2 leading-none border-0 focus:outline-none",
            { "ml-2": withIcon }
          )}
